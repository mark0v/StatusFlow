...
- the current mobile screen can fetch orders, preserve search/filter/sort state, support pull-to-refresh and empty states, create a new order, inspect live order details, post operator comments, and trigger allowed status transitions
